...
public class AstronautManager : Singleton<AstronautManager>
{
    ...
    void Start()
    {
        ...
        keywordCollection.Add("Grow", GrowCommand);
        keywordCollection.Add("Shrink", ShrinkCommand);
    ...
    {
        InteractibleManager.Instance.FocusedGameObject.SendMessageUpwards("PlayAudio");
    }
    private void GrowCommand(PhraseRecognizedEventArgs args)
    {
        InteractibleManager.Instance.FocusedGameObject.SendMessageUpwards("Grow");
    }
    private void ShrinkCommand(PhraseRecognizedEventArgs args)
    {
        InteractibleManager.Instance.FocusedGameObject.SendMessageUpwards("Shrink");
    }
    private void StopCommand(PhraseRecognizedEventArgs args)
    {
        InteractibleManager.Instance.FocusedGameObject.SendMessageUpwards("StopSpin");
    }
